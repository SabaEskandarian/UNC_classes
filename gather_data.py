...
while termCounter < numTerms:
    ...
    #Depts causing problems, to be added back in later: BCB, GEOL, MASC
    ...
    dept_list = ["COMP", "AAAD", "AMST", "ANTH", "APPL", "ASTR", "BIOL", "BIOS", "BMME", "BUSI", "CHEM", "CLAR", "CMPL", "COMM", "DRAM", "ECON", "EDUC", "ENEC", "ENGL", "ENVR", "EPID", "EXSS", "GEOG", "HIST", "INLS", "LING", "MATH", "MEJO", "PHIL", "PHYS", "PLAN", "PLCY", "POLI", "PSYC", "ROML", "SOCI", "STOR", "WGST"]
